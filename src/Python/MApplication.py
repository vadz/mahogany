...
class MApplicationPtr :
    ...
    def ErrorMessage(self,arg0,arg1,arg2):
        val = MApplicationc.MApplication_ErrorMessage(self.this,arg0,arg1,arg2)
        return val
    def SystemErrorMessage(self,arg0,arg1,arg2):
        val = MApplicationc.MApplication_SystemErrorMessage(self.this,arg0,arg1,arg2)
        return val
    def FatalErrorMessage(self,arg0,arg1):
        val = MApplicationc.MApplication_FatalErrorMessage(self.this,arg0,arg1)
        return val
    def Message(self,arg0,arg1,arg2):
        val = MApplicationc.MApplication_Message(self.this,arg0,arg1,arg2)
        return val
    def YesNoDialog(self,arg0,arg1,arg2,*args):
        val = apply(MApplicationc.MApplication_YesNoDialog,(self.this,arg0,arg1,arg2,)+args)
        return val
    ...
    def Log(self,arg0,arg1):
        val = MApplicationc.MApplication_Log(self.this,arg0,arg1)
        return val
    def __repr__(self):
