...
static String *new_String(const char * _arg0) {
    return new String(_arg0);
}
...
static char * String_c_str(String *obj) {
    char * _result = (char *)obj->c_str();
    return _result;
}
