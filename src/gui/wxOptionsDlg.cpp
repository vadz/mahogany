...
// ConfigField_NewMailFolder,
   ...
   ConfigField_MessageViewQuotedColour,
   ConfigField_MessageViewQuoted2Colour,
...
// { gettext_noop("Folder where to collect &new mail"), Field_Text, -1},
   ...
   { gettext_noop("Colour for &quoted text"),      Field_Color,   -1 },
   { gettext_noop("Colour for &2nd level quoted text"),Field_Color,   -1 },
...
// CONFIG_ENTRY(MP_NEWMAIL_FOLDER),
   ...
   CONFIG_ENTRY(MP_MVIEW_QUOTEDCOLOUR),
   CONFIG_ENTRY(MP_MVIEW_QUOTED2COLOUR),
