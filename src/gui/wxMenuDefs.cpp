...
// { WXMENU_FILE_PAGE_SETUP_PS,    gettext_noop("P&age PS Setup"),     gettext_noop("Configure PostScript page setup")  , FALSE },
   ...
   { WXMENU_MSG_REPLY_WITH_TEMPLATE, gettext_noop("Reply with &template...\tCtrl-T"), gettext_noop("Reply to this message after choosing a template to use ")    , FALSE },
   ...
   { WXMENU_MSG_FORWARD_WITH_TEMPLATE, gettext_noop("Forward with te&mplate...\tCtrl-M"), gettext_noop("Forward this message after choosing a template to use ")     , FALSE },
   ...
   { WXMENU_MSG_SEARCH,  gettext_noop("&Search...\tCtrl-S"),
   ...
   { WXMENU_SEPARATOR,     "",                  ""                         , FALSE },
   { WXMENU_COMPOSE_SAVETEXT,gettext_noop("Save &text...\tCtrl-S"),   gettext_noop("Save message text to file"), FALSE },
