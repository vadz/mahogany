...
#define   MP_FROM_LABEL         "FromLabel"
/// the label for the To: field
#define   MP_TO_LABEL         "ToLabel"
/// the label for the CC: field
#define   MP_CC_LABEL         "CcLabel"
/// the label for the BCC: field
#define   MP_BCC_LABEL         "BccLabel"
...
/// the label for the From: field
#define   MP_FROM_LABEL_D         "From:"
/// the label for the To: field
#define   MP_TO_LABEL_D         "To:"
/// the label for the CC: field
#define   MP_CC_LABEL_D         "CC:"
/// the label for the BCC: field
#define   MP_BCC_LABEL_D       "BCC:"
/// the printf() format for dates
